 ...
 * Generated for Laravel 5.2.45 on 2017-05-05.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Hash {
        ...
        {
            return \App\MD5\MD5Hasher::make($value, $options);
        }
        ...
        {
            return \App\MD5\MD5Hasher::check($value, $hashedValue, $options);
        }
        ...
        {
            return \App\MD5\MD5Hasher::needsRehash($hashedValue, $options);
        }
