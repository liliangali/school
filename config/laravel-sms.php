    ...
    'validation' => [
        'mobile' => [
            ...
            'staticRules' => [
                ...
                'check_mobile_unique' => 'required|zh_mobile|unique:member,phone_mob',
...
//            'default'     => 'mobile_required',
//            'staticRules' => [
//                'mobile_required'     => 'required|zh_mobile|unique:member,mobile',
...
//        return '【signature】您的验证码是' . $code . '，有效期为' . $minutes . '分钟，请尽快验证。';
    ...
    */
    'templates' => [
        'Alidayu'    => \App\Models\LaravelSms::REG_TEMP_ID,
    ],
